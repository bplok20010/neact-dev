    ...
    1: [function(require, module, exports) {
        ...
        function renderTree(nodes) {
            ...
            for (i = 0; i < nodes.length; i++) {
                n = nodes[i];
                if (n.children !== null) {
                    children[i] = createVNode('div', null, renderTree(n.children));
                } else {
                    children[i] = createVNode('span', null, n.key);
                }
            }
            return children;
        }
        ...
        BenchmarkImpl.prototype.tearDown = function() {
            Neact.render(null, this.container);
        };

        BenchmarkImpl.prototype.render = function() {
            Neact.render(
                createVNode('div', null, renderTree(this.a)),
                this.container
            );
        };
        ...
        BenchmarkImpl.prototype.update = function() {
            Neact.render(
                createVNode('div', null, renderTree(this.b)),
                this.container
            );
        };
