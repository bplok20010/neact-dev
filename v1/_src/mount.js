...
function premount(vnode, parentInst, parentDOM, insertedVnodeQueue) {

    var inst = instantiateComponent(vnode, parentInst);

    return mountInstance(inst, parentDOM, insertedVnodeQueue);
...
function mount(vnode, parentInst, parentDOM, before) {
    ...
    //var inst = premount(vnode, parentInst, parentDOM, insertedVnodeQueue);
