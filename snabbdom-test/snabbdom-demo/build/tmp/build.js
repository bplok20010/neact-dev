...
/***/function (module, exports, __webpack_require__) {
	...
	var _snabbdomJsx = __webpack_require__(1);
	...
	var patch = _snabbdom2['default'].init([__webpack_require__(8), __webpack_require__(9), __webpack_require__(10), __webpack_require__(11)]);

	//HelloMessage : (attrs, body) -> vnode
	var HelloMessage = function HelloMessage(_ref) {
		var name = _ref.name;
		return (0, _snabbdomJsx.html)('div', { 'on-click': function onClick(_) {
				return alert('Hi ' + name);
			} }, name);
	};

	var test = (0, _snabbdomJsx.html)('div', null, 'Hello JSX');

	var vnode = (0, _snabbdomJsx.html)(HelloMessage, { name: 'Yassine' }, (0, _snabbdomJsx.html)('div', null, '1'), test, (0, _snabbdomJsx.html)('div', null, '2'));
...
/***/function (module, exports) {
	...
	function isPrimitive(val) {
		return typeof val === 'string' || typeof val === 'number' || typeof val === 'boolean' || (typeof val === 'undefined' ? 'undefined' : (0, _typeof3['default'])(val)) === 'symbol' || val === null || val === undefined;
	}
